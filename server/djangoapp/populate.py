...
def initiate():
    ...
    print("CarMakes populated:", car_make_instances)  # Debug print
    ...
    for data in car_model_data:
        print("Trying to insert:", data)  # Debug print
    ...
    print("Car Models populated:", CarModel.objects.all())  # Debug print